...
import { calculateBorrowAPY, calculateLpAPY, secondsInAYear } from "../src/functions";
...
describe("APY Calculation Functions", () => {
    ...
    it("should calculate APY correctly for high utilization rate without rewards", () => {
      ...
      expect(calculateLpAPY(utilizationRate, testApyParams(), protocolReservePercentage)).toBeCloseTo(apy);
    });
});
